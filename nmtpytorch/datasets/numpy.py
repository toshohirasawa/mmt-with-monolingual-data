...
class NumpyDataset(Dataset):
    ...
    def __init__(self, fname, key=None, order_file=None, revert=False, n_feats=None, **kwargs):
        ...
        if self.n_feats:
            assert self.data.shape[-1] >= self.n_feats
            self.data = self.data[:, :, :self.n_feats]
